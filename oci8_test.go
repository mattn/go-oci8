...
func TestParseDSN(t *testing.T) {
	...
	var dsnTests = []struct {
		...
		{"sys/syspwd@107.20.30.169:1521/ORCL?loc=America%2FLos_Angeles as sysdba", &DSN{Username: "sys", Password: "syspwd", Connect: "107.20.30.169:1521/ORCL", prefetch_rows: 10, Location: pacific, mode: "sysdba"}},
